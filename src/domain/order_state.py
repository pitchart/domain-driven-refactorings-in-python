...
from src.domain.exceptions import OrderCannotBeShippedException, ApprovedOrderCannotBeRejectedException, \
    ShippedOrdersCannotBeChangedException, OrderCannotBeShippedTwiceException, RejectedOrderCannotBeApprovedException
...
class OrderState(ABC):
    ...
    @staticmethod
    def create(status: OrderStatus) -> 'OrderState':
        cases = {
